		...
		if (avoidON && Byte.parseByte(campos[0]) == Comunicar.EVITAR) {
			...
			case Comunicar.AVOIDON:
				...
				case Comunicar.TRUE:
					...
					avoidON = true;
					System.out.printf("com boolean true(%b): gestor avoidOn a \n", avoidON);
					break;
				case Comunicar.FALSE:
					avoidON = false;
					System.out.printf("com boolean true(%b): gestor avoidOn b\n", avoidON);
					break;
				}
				break;
			}
			...
			case Comunicar.EVITAR:
				...
				case Comunicar.AVOIDON:
					...
					case Comunicar.TRUE:
						avoidON = true;
						System.out.printf("com boolean true(%b): gestor avoidOn c \n", avoidON);
						break;
					case Comunicar.FALSE:
						avoidON = false;
						System.out.printf("com boolean true(%b): gestor avoidOn d \n", avoidON);
						break;
					}
					break;
				}
